...
DATA_FILE_OVERRIDE: str | None = "../../outputs/ho_rlsl_results.npz"

# Lay changepoint 1024Hz ERN tu 5 phuong phap trong outputs/fcca_results.
CHANGEPOINT_KEY = "1024Hz_ERN"
CHANGEPOINT_METHOD_FILES = {
    "CP_Tracking": Path("../../outputs/fcca_results") / "CP_Tracking" / "CP_ChangePoints.npy",
    "DMD": Path("../../outputs/fcca_results") / "DMD" / "DMD_ChangePoints.npy",
    "HOSVD": Path("../../outputs/fcca_results") / "HOSVD" / "HOSVD_ChangePoints.npy",
    "HO_RLSL": Path("../../outputs/fcca_results") / "HO_RLSL" / "HORLSL_ChangePoints.npy",
    "PELT": Path("../../outputs/fcca_results") / "PELT" / "PELT_ChangePoints.npy",
}

OUTPUT_DIR_NAME = "fcca_ern_by_method"
...
def cluster_ern_fcca_paper(k_input: Any = None) -> dict[str, Any]:
    ...
    output_root = base_dir.parent.parent / "outputs" / "fcca_results" / OUTPUT_DIR_NAME
